    ...
    <div class="col-md-6">
        <form action="{{ url('absensi/masuk') }}" method="get">
            <div class="input-group">
                <input type="text" name="keywords" class="form-control" placeholder="Cari nama atau instansi..." value="{{ request('keywords') }}">
                <span class="input-group-append">
                    <button type="submit" class="btn btn-info btn-flat">
                        <i class="fa fa-search"></i> Cari
                    </button>
                    <a href="{{ url('adminteam/masuka/tambah') }}" class="btn btn-success">
