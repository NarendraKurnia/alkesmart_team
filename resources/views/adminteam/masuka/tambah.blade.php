...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Form Kunjungan Marketing</h3>
    </div>
    <div class="card-body">
        @if ($errors->any())
        ...
        <form action="{{ url('adminteam/masuka/proses-tambah') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
        {{ csrf_field() }}
    ...
    <input type="date" class="form-control" value="{{ old('tanggal_kunjungan') }}">
            </div>
        </div>
