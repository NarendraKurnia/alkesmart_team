...
class ShiftmasukController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Filter agar hanya data dengan nama yang sama dengan user login yang muncul
        $all = $all->filter(function ($item) use ($userName) {
            return $item->nama === $userName;
        });
        // ----------------------------

        // Filter pencarian (keywords) tetap berjalan di dalam data yang sudah terfilter nama tadi
